                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Customer management</h2>
                                    <a href="toaddcustomer.htm"><button class="au-btn au-btn-icon au-btn--blue">
                                        <i class="zmdi zmdi-plus"></i>Add new customer</button></a>
                                </div>
                            </div>
                        </div>
                        <hr>
                                    ...
                                    <table class="table table-borderless table-striped table-earning" style="font-size: 14px;;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-size: 14px;">Identification number</th>
                                                <th style="font-size: 14px;">Date of birth</th>
                                                <th style="font-size: 14px;">User name</th>
                                                <th style="font-size: 14px;">Password</th>
                                        ...
                                        <c:forEach var="item" items="${listcustomer}" >
                                            ...
                                            <td style="padding: 20px;">
                                                <a href="toupdatecustomer.htm?customerId=${item.customerId}"><i class="fas fa-pencil-square-o" style="font-size: 30px;; color: gray"></i></a>
                                            </td>
                                            <td><img style="width: 50px; height: 50px;" src="../resources/images/${item.profilePicture}" /></td>
                                            ...
                                            <td><c:out value="${item.adminPermission}" /></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
