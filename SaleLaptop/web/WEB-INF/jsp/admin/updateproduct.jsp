            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Update product</h2>
                        ...
                        <hr>
                        <hr>
                        <f:form action="updateproduct.htm"  modelAttribute="product" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                <div class="col-12 col-md-10">
                                    <f:input path="productId" cssClass="form-control" hidden="true"/>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-2">
