            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Update customer</h2>
                        ...
                        <hr>
                        <hr>
                        <f:form action="updatecustomer.htm"  modelAttribute="customer" method="post" class="form-horizontal">
                            <div class="row form-group">
                                <<div class="row form-group">
                                <div class="col-12 col-md-10">
                                    <f:input path="customerId" cssClass="form-control" hidden="true" />
                                </div>
                            </div>
                            </div>
                            <div class="row form-group">
