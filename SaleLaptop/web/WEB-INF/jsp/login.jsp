                    ...
                    <div class="login-wrap">
                        <div class="login-content">
                            ...
                            <div class="login-form">
                                <f:form action="login.htm" modelAttribute="customer1" method="POST">
                                    ...
                                    <div class="login-checkbox">
                                        ...
                                        <label>
                                            <a href="toforgotpassword.htm">Forgot password</a>
                                        </label>
                                    </div>
                                    <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Login</button>
                                    <div class="social-login-content">
                                        <div class="social-button">
                                            <a href="index.htm" style="width: 480px;"><button class="au-btn au-btn--block au-btn--blue m-b-20">Home</button></a>
                                        </div>
                                    </div>
                                    <div class="register-link">
                                        <p>
                                            If you do not have an account,
                                            <a href="toregister.htm"> register here</a>
                                        </p>
                                    </div>
                                </f:form>
                            </div>
