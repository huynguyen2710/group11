                    ...
                    <div class="login-wrap">
                        <div class="login-content">
                            ...
                            <div class="login-form">
                                <f:form action="send2.htm" modelAttribute="customer1" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>Email</label>
                                        <f:input cssClass="au-input au-input--full" type="email" path="email"/>
                                        <p style="color: red"><f:errors path="email"/></p>
                                    </div>
                                    <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">confirm</button>
                                </f:form>
                            </div>
                        </div>
                    </div>
