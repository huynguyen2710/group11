            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Add new supplier</h2>
                        ...
                        <hr>
                        <hr>
                        <f:form action="createsupplier.htm"  modelAttribute="supplier" method="post" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-2">
                                    <label for="text-input" class=" form-control-label">Supplier ID</label>
                                </div>
                                <div class="col-12 col-md-10">
                                    <f:input path="supplierId" cssClass="form-control" />
                                    <p style="color: red"><f:errors path="supplierId" /></p>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-2">
